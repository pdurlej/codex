...
- `thread/contextPins/list`, `thread/contextPins/create`, `thread/contextPins/update`, `thread/contextPins/delete` — manage bounded, persisted text snippets for a materialized thread. Active pins are re-sent to the model as untrusted user-provided context on future turns, including after compaction.
...
Use `thread/contextPins/*` to persist short text snippets that should be supplied to future turns for a materialized thread. Pins are bounded to 16 entries per thread, 16 KiB per pin, and 64 KiB total text. They are injected as untrusted user-provided context; they do not grant approval, do not override system or developer instructions, and are not available on ephemeral threads.

```json
{ "method": "thread/contextPins/create", "id": 31, "params": {
    "threadId": "thr_123",
...
{ "method": "thread/contextPins/list", "id": 32, "params": {
    "threadId": "thr_123",
    "limit": 16
} }
{ "id": 32, "result": {
...
{ "method": "thread/contextPins/update", "id": 33, "params": {
    "threadId": "thr_123",
    "pinId": "8b9a0a25-0db9-4cce-a2a3-93e3161c0a3e",
...
{ "method": "thread/contextPins/delete", "id": 34, "params": {
    "threadId": "thr_123",
    "pinId": "8b9a0a25-0db9-4cce-a2a3-93e3161c0a3e"
} }
